...
//j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/home/vahle/MinosSoft/test/NueAna/data/FarPidsmock.dat");
//j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/home/vahle/MinosSoft/test/NueAna/data/FarPids-cuts.dat");
j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/home/vahle/MinosSoft/test/NueAna/data/MockDataPids-cuts.dat");

//set decider
j.Path("Main").Mod("FillPIDFromText").Set("Decider=5");
