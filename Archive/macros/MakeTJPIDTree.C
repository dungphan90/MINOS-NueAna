...
j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/afs/fnal.gov/files/home/room2/tjyang/test/macros/nueana/pidmc.tj");

////tj's pid file from challenge set
//j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/afs/fnal.gov/files/home/room2/tjyang/test/macros/nueana/pidmdc.tj");
//j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/afs/fnal.gov/files/data/minos/d04/vahle/test/NueAna/data/pidmdc.tj");

//josh and mayly's mc pid
//j.Path("Main").Mod("FillPIDFromText").Set("TextFile=/home/vahle/MinosSoft/test/NueAna/data/pid.jbms");

//set decider
j.Path("Main").Mod("FillPIDFromText").Set("Decider=3");
...
sprintf(setfilename,"FileName=%sPIDNue-%s_%s.root",path,rnumstring.c_str(),subrunstring.c_str());
