...
j.Msg.SetLevel("NtpStTrimmer","Debug");
...
JobCModule& nue_mod = main_path.Mod("NtpStTrimmer"); 
...
nue_mod.Set("FileCut=1");
nue_mod.Set("TrimFile=test.txt");
...
nue_mod.Set("CutOnClasses=0");  //default option
...
j.Path("Main").Mod("Output").Cmd("DefineStream NtpSt NtpStRecord NtpSt_trim");
