...
void near_mc_standard_hornOFF_ParticlePID(string path, int sys=0)
{
...
//	p.AddInputFiles("/minos/data/mini_08_26/standard/Griffin_Production_v00/near/MC/standard/horn_off/alllinks/*");


	//string path = "/minos/data/Dogwood1_Near/Standard/out/minos/data/analysis/nue/2ndAnalysis/AnaNue_Files/BeforeLEM/Full/Untrimmed/Near/MC/L010000N/Standard";	
