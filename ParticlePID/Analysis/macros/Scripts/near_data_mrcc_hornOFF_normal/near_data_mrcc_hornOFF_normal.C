...
void near_data_mrcc_hornOFF_normal(string path, int sys=0)
{

	printf("NO near data mrcc horn off \n");exit(1);
...
//	string path="/minos/data/Dogwood1_Near/MRCC/out/minos/data/analysis/nue/2ndAnalysis/AnaNue_Files/BeforeLEM/Full/Untrimmed/Near/Data/L010000N/Standard/";
