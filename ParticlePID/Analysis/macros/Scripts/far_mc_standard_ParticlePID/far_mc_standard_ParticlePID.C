...
void far_mc_standard_ParticlePID(string path, int sys=0)
{
	...
	///minos/data/mini_08_26/standard/Griffin_Production_v00/far/MC/far_MC_dogwood1_Griffin_Production_v00
