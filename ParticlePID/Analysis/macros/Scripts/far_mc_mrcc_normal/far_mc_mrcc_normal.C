...
void far_mc_mrcc_normal(string path, int sys=0)
{
...
//	gSystem->CompileMacro("/data/minos/NueAnalysis/Code/MiniPlotMaker/MiniPlotMaker.C");
	...
	//p.AddInputFiles("/minos/data/mini_all_mrcc/Griffin_Production_v00/far/MC/far_MC_dogwood1_Griffin_Production_v00/AnaNue-f210*",0);
	//p.AddInputFiles("/minos/data/mini_all_mrcc/Griffin_Production_v00/far/MC/far_MC_dogwood1_Griffin_Production_v00/AnaNue-f213*",1);
	//p.AddInputFiles("/minos/data/mini_all_mrcc/Griffin_Production_v00/far/MC/far_MC_dogwood1_Griffin_Production_v00/AnaNue-f214*",2);
