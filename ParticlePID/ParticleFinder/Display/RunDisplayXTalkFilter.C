...
void RunDisplayXTalkFilter(string sntp_file="",string mrnt_file="")
{
  ...
  jc->Path.Create("default","XTalkFilter::Reco ParticleFinder::Reco  ParticleAna::Reco ParticleDisplay::Ana");
